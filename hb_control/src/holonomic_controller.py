...
class PID:
    ...
    def reset(self):
        self.pid_params = {
            'x': {'kp': 0.0, 'ki': 0.00, 'kd': 0.00, 'max_out': self.max_vel},
            'y': {'kp': 0.0, 'ki': 0.00, 'kd': 0.00, 'max_out': self.max_vel},
...
class HolonomicPIDController(Node):
    def __init__(self):
        ...
        self.pid_params = {
            'x': {'kp': 0.55, 'ki': 0.00, 'kd': 0.7, 'max_out': self.max_vel},
            'y': {'kp': 0.55, 'ki': 0.00, 'kd': 0.1, 'max_out': self.max_vel},
            'theta': {'kp': 2.0, 'ki': 0.00, 'kd': 0.35, 'max_out': 2.0}
        }
    ...
    def control_cb(self):
        ...
        if not self.goal_reached:
            ...
            error_yaw = 1.0-self.current_pose_bot_yaw
            ...
            if abs(error_x) < 150 and abs(error_y)< 150 :
